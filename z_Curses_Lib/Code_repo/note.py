def note_default_setting():
    ...
    print("   Ham nay co chuc nang thuc hien thay doi thanh:")
    print("      noecho(),cbreak(),keypad(True)")
    print("** Neu khong dong wrapper, sau khi ket thuc chuong trinh ma quen thiet lap cau hinh cu")
